...
<body class="bg-gray-50 dark:bg-gray-950 overflow-x-hidden transition-all">
    <div class="min-h-screen">
        <div class="antialiased">
            ...
            <section class="w-full max-w-7xl lg:px-8 sm:px-6 mx-auto">
                ...
                <div class="grid grid-cols-3 gap-6">
                    <div class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div class="px-5 pb-5">
                            <a href="#">
                                <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Tênis Nike Sport Off-White</h5>
                            </a>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <a href="#" class="text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-blue-800">Add to cart</a>
                            </div>
                        </div>
                    </div>
                    <div class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
